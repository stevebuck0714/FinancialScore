...

{
  ...
  const handleFile = async (e: ChangeEvent<HTMLInputElement>) => {
    ...
    const firstCell = json[0] && Array.isArray(json[0]) ? json[0][0] : null;
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '32px' }}>
          ...
          {(() => {
            ...
            const cashFlowData = last12.map((curr, idx) => {
              ...
              const depreciation = curr.depreciationExpense || 0; // Estimated as ~2% of revenue if not available
