  ...
  const submitForm = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const description = [
        ...
        '',
        'Complete the form below and our team will discuss the onboarding process, pricing and walk you through how to activate your live environment.',
        '',
        'Contact Information',
      ...
      >
        ...
        <form onSubmit={submitForm} style={{ marginTop: '16px' }}>
          ...
          <p style={{ margin: '6px 0 0 0', fontSize: '12px', color: '#64748b' }}>
            Use <a href="mailto:support@corelytics.com" style={{ color: '#2563eb', textDecoration: 'none' }}>support@corelytics.com</a>
          </p>
