  ...
  return (
    <div className="valuation-sde-print-root" style={{ border: '1px solid #e2e8f0', borderRadius: '10px', overflow: 'hidden', background: '#fff' }}>
      ...
      <div style={{ padding: '18px 20px', borderBottom: '1px solid #e2e8f0', background: '#f8fafc' }}>
        ...
        <div style={{ fontSize: '24px', color: '#1e293b', fontWeight: 800, marginTop: '4px' }}>5. SDE Valuation</div>
        ...
        <div style={{ fontSize: '12px', color: '#64748b', marginTop: '8px' }}>
          Data source: Company financial data ({latestFinancialSource || 'connected source'}) — matches SDE Valuation workspace
        </div>
      </div>
