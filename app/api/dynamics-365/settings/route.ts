...
export async function GET(request: NextRequest) {
  try {
    ...
    const platformSettings =
      metadata.dynamicsSettings &&
      typeof metadata.dynamicsSettings === 'object' &&
      !Array.isArray(metadata.dynamicsSettings)
        ? (metadata.dynamicsSettings as Record<string, unknown>)
        : {};
