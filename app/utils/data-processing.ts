...
export function normalizeRows(raw: any[], mapping: Mappings): NormalRow[] {
  ...
  for (const r of raw) {
    ...
    const row: NormalRow = {
      ...
      cash: N(mapping.cash),
      ar: N(mapping.ar),
      retainageReceivables: N(mapping.retainageReceivables),
      contractAssets: N(mapping.contractAssets),
      inventory: N(mapping.inventory),
      otherCA: N(mapping.otherCA),
      tca: N(mapping.tca),
      fixedAssets: N(mapping.fixedAssets),
      constructionEquipment: N(mapping.constructionEquipment),
      officeEquipment: N(mapping.officeEquipment),
      shopEquipment: N(mapping.shopEquipment),
      investments: N(mapping.investments),
      rightOfUseLeases: N(mapping.rightOfUseLeases),
      otherAssets: N(mapping.otherAssets),
      totalAssets: N(mapping.totalAssets),
      ap: N(mapping.ap),
      loc: N(mapping.loc),
      contractLiabilities: N(mapping.contractLiabilities),
