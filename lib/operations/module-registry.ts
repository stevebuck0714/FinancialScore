...
const MODULE_DEFINITIONS: ModuleDefinition[] = [
  ...
  { key: 'groups', label: 'Group', dataType: 'products' },
  ...
  { key: 'residential_real_estate', label: 'Residential Real Estate', dataType: 'products' },
  { key: 'mortgage', label: 'Mortgage', dataType: 'products' },
