...
export const reportDatasets: ReportDataset[] = [
  {
    id: 'workforce_departments',
    label: 'Workforce Departments',
  ...
  {
    id: 'workforce_employee_roster',
    label: 'Workforce Employee Roster',
    ...
    entityFilters: [
      ...
      { field: 'role', entityType: 'role', aliases: ['role', 'job title'] },
      { field: 'location', entityType: 'location', aliases: ['location', 'office'] },
    ],
    columns: [
      ...
      col('location', 'Location', 'text', ['location', 'office']),
      col('employmentStatus', 'Status', 'text', ['status', 'employment status']),
      col('payType', 'Pay Type', 'text', ['pay type']),
      col('paidPer', 'Paid Per', 'text', ['paid per', 'pay frequency']),
